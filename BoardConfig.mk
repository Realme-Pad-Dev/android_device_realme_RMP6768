...
TARGET_KERNEL_ADDITIONAL_FLAGS := KBUILD_BUILD_USER="neilchetty" KBUILD_BUILD_HOST=BlueLight
...
ifeq ($(ARROW_GAPPS),true) # Reserve 100MB free space each
BOARD_SYSTEMIMAGE_EXTFS_INODE_COUNT := -1
BOARD_SYSTEMIMAGE_PARTITION_RESERVED_SIZE := 104857600
BOARD_PRODUCTIMAGE_EXTFS_INODE_COUNT := -1
BOARD_PRODUCTIMAGE_PARTITION_RESERVED_SIZE := 104857600
else # Reserve 500MB free space each
...
TARGET_RECOVERY_FSTAB := $(DEVICE_PATH)/vendor_overlay/etc/fstab.mt6768
